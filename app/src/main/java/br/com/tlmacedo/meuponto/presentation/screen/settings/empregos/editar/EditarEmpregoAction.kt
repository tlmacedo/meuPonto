...
sealed class EditarEmpregoAction {
    ...
    data class AlterarCoordenadas(val lat: Double?, val lon: Double?) : EditarEmpregoAction()
    data class AlterarRaioGeofencing(val raio: Int) : EditarEmpregoAction()
    data class SetShowLocationPicker(val show: Boolean) : EditarEmpregoAction()
